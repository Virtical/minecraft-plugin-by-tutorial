package ru.virtical.tutorialmod.block;
...
import ru.virtical.tutorialmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(PluginByTutorial.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, new Identifier(PluginByTutorial.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings()));
    }

    public static void registerModBlocks() {
        PluginByTutorial.LOGGER.info("Registering Mod Blocks for " + PluginByTutorial.MOD_ID);
    }
}
